...
cur.execute("CREATE TABLE IF NOT EXISTS PROD_DETAILS (PROD_ID INT(3) AUTO_INCREMENT PRIMARY KEY, PROD_NAME VARCHAR(200) NOT NULL UNIQUE);")
cur.execute("CREATE TABLE IF NOT EXISTS PROD_BUY_COST (PROD_BUY_PRICE INT(20) NOT NULL);")
cur.execute("CREATE TABLE IF NOT EXISTS PROD_SELL_COST (PROD_SELL_PRICE INT(10) NOT NULL);")
